...
ball1.v=2*vector(0,-1,0)
ball2.v=2*vector(0,-1,0)
ball3.v=2*vector(0,-1,0)
ball4.v=2*vector(0,-1,0)
ball5.v=2*vector(0,-1,0)
ball6.v=2*vector(0,-1,0)
ball7.v=2*vector(0,-1,0)
ball8.v=2*vector(0,-1,0)
ball9.v=2*vector(0,-1,0)
ball10.v=2*vector(0,-1,0)
...
while 1:
    ...
    for thisball in ballsList:
        ...
        if thisball.pos.x>10:
            thisball.pos=thisball.pos-thisball.v*dt
            thisball.v=2*vector(0,1,0)
        elif thisball.pos.x<-10:
            thisball.pos=thisball.pos-thisball.v*dt
            thisball.v=2*vector(0,-1,0)
        elif thisball.pos.y<-10:
            thisball.pos=thisball.pos-thisball.v*dt
            thisball.v=2*vector(1,0,0)
        elif thisball.pos.y>10:
            thisball.pos=thisball.pos-thisball.v*dt
            thisball.v=2*vector(-1,0,0)
