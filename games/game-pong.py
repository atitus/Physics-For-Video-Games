...
#
#Pong with elastic collisions
#
#Press the spacebar to begin. Move your mouse up and down to control the paddle.


print "Press the spacebar to begin. Move your mouse up and down to control the paddle."
