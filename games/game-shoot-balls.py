...
#
#Shoot the balls. Use the left and right arrow keys to change the direction of the shooter. Use the spacebar to shoot a missile.

print "Shoot the balls. Use the left and right arrow keys to change the direction of the shooter. Use the spacebar to shoot a missile."
